...
assert_matrix_value "components.gpu_platform_addon.version" "${GPU_PLATFORM_ADDON_VERSION}"
assert_matrix_value "components.gpu_platform_addon.n_minus_one_version" "${GPU_PLATFORM_ADDON_N_MINUS_ONE_VERSION}"
assert_matrix_value "components.gpu_platform_addon.n_minus_one_revision" "${GPU_PLATFORM_ADDON_N_MINUS_ONE_REVISION}"
assert_matrix_value "components.gpu_platform_addon.lifecycle_signing_duration" "${ADDON_LIFECYCLE_SIGNING_DURATION}"
