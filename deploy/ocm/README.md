...
- `ManagedClusterAddOn` deletion, ServerSideApply Add-on Lease ownership and cleanup, spoke resource cleanup, Hub permission cleanup, inventory garbage collection, and the intentional orphaned install Namespace;
